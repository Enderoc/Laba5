...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pMesh1->LoadMesh("D:/Makhmutov_Amal/Inger/Texture/phoenix_ugv.md2")) {
            return false;
        }

        m_pMesh2 = new Mesh();

        if (!m_pMesh2->LoadMesh("D:/Makhmutov_Amal/Inger/Texture/jeep.obj")) {
            return false;
        }

        m_pMesh3 = new Mesh();

        if (!m_pMesh3->LoadMesh("D:/Makhmutov_Amal/Inger/Texture/hheli.obj")) {
            return false;
        }
