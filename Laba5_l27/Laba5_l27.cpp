...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pGround->LoadMesh("D:/Makhmutov_Amal/Inger/Texture/quad.obj")) {
            return false;
        }

        if (!m_billboardList.Init("D:/Makhmutov_Amal/Inger/Texture/monster_hellknight.png")) {
            return false;
        }

        m_pTexture = new Texture(GL_TEXTURE_2D, "D:/Makhmutov_Amal/Inger/Texture/brick.png");
        ...
        m_pNormalMap = new Texture(GL_TEXTURE_2D, "D:/Makhmutov_Amal/Inger/Texture/normal_map.jpg");
